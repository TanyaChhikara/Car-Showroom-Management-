...
This project has been designed using features of C++ programming language - Data File Handling and OOPS Concepts: classes. It is useful for the Managers to sell cars and keep records of the customers and their details. It uses various OOPS features like inheritance, classes and polymorphism etc.
## Output Screenshots
